...
{
  ros::init(argc, argv, "planning_example_execution");
...
//        psm.getPlanningScene()->getCollisionWorld()->addToObject("shelf_center", shapes::ShapeConstPtr(new shapes::Box(0.22, 0.25, thickness_shelfs)), t);
      ...
      for (unsigned int i = 0 ; i < joint_names_.size(); i++)
      {
        ...
        //std::cout<<traj_init.joint_names_[i] <<": "<<traj_init.points[0].positions[i]<< std::endl;
...
//      srv.request.right_hand_position.z = 0.25;
